 ...
 *
 * Only MOMENTARY mode is supported
 *
...
#define GPIO_INPUT_PIN_SEL (1ULL<<GPIO_INPUT_GPIO0)
...
#define GPIO_OUTPUT_PIN_SEL ((1ULL<<GPIO_OUTPUT_READER_POWER) | (1ULL<<GPIO_OUTPUT_RELAY_POWER) | (1ULL<<GPIO_OUTPUT_CONNECTED_LED) | (1ULL<<GPIO_OUTPUT_ACCESS_LED))
